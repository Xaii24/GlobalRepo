...
<div class="view-background">
    <h1>NEEDLE COUNTER</h1>

    <?php if (!empty($needleProduct->items)): ?>
        <p class="total-items"><?= count($needleProduct->items) ?> Results</p>
        <div class="items-grid"> <!-- Grid container -->
            <?php foreach ($needleProduct->items as $item): ?>
    ...
    <?php else: ?>
        <p>No items found under the "Needle Items" product.</p>
    <?php endif; ?>
</div>
