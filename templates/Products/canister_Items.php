...
<div class="view-background">
    <h1>SURGICAL GOWNS</h1>

    <?php if (!empty($canisterProduct->items)): ?>
        <p class="total-items"><?= count($canisterProduct->items) ?> Results</p>
        <div class="items-grid"> <!-- Grid container -->
            <?php foreach ($canisterProduct->items as $item): ?>
    ...
    <?php else: ?>
        <p>No items found under the "Canister Gowns" product.</p>
    <?php endif; ?>
</div>
